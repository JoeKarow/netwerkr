...
export interface CompleteContactPhone
	extends z.infer<typeof ContactPhoneModel> {
 ...
 */
export const RelatedContactPhoneModel: z.ZodSchema<CompleteContactPhone> =
	z.lazy(() =>
		ContactPhoneModel.extend({
