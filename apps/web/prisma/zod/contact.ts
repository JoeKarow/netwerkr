...
import {
	CompleteContactEmail,
	RelatedContactEmailModel,
	CompleteContactPhone,
	RelatedContactPhoneModel,
	CompleteSocialMedia,
 ...
 */
export const RelatedContactModel: z.ZodSchema<CompleteContact> = z.lazy(() =>
	ContactModel.extend({
